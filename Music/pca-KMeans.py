...
# Step 3: Add polynomial features (degree 3)
...
# Step 8: Plot PCA with KMeans Clustering
...
plt.title('KMeans Clustering on PCA-Reduced Polynomial Features (Iris Dataset)', fontsize=14)
