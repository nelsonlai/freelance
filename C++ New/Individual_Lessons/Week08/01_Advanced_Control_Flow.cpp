 ...
 * 
 * This file demonstrates nested structures, complex conditions, statement scope
 */
...
int main() {
    std::cout << "=== C++ Advanced Control Flow Demo ===" << std::endl;
    std::cout << "This program demonstrates nested structures, complex conditions, statement scope.\n" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -o 08_1 08_1_Advanced_Control_Flow.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -o 08_1 08_1_Advanced_Control_Flow.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc 08_1_Advanced_Control_Flow.cpp
 * 
 * Running:
 * ./08_1 (Linux/macOS)
 * 08_1.exe (Windows)
