 ...
 * 
 * This file demonstrates block scope, variable lifetime, raii principles
 */
...
int main() {
    std::cout << "=== C++ Statement Scope and Lifetime Demo ===" << std::endl;
    std::cout << "This program demonstrates block scope, variable lifetime, raii principles.\n" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -o 08_3 08_3_Statement_Scope_and_Lifetime.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -o 08_3 08_3_Statement_Scope_and_Lifetime.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc 08_3_Statement_Scope_and_Lifetime.cpp
 * 
 * Running:
 * ./08_3 (Linux/macOS)
 * 08_3.exe (Windows)
