/*
 * Lesson 13.3: Stream Operators
 * 
 * This file demonstrates advanced C++ concepts including
 * input/output stream operators, custom stream manipulators
 */
...
int main() {
    std::cout << "=== Advanced C++ Stream Operators Demo ===" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 13_3_Stream_Operators.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 13_3_Stream_Operators.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc /O2 13_3_Stream_Operators.cpp
 * 
 * Running:
