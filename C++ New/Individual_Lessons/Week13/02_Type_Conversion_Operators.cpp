/*
 * Lesson 13.2: Type Conversion Operators
 * 
 * This file demonstrates advanced C++ concepts including
 * conversion operators, explicit conversions
 */
...
int main() {
    std::cout << "=== Advanced C++ Type Conversion Operators Demo ===" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 13_2_Type_Conversion_Operators.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 13_2_Type_Conversion_Operators.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc /O2 13_2_Type_Conversion_Operators.cpp
 * 
 * Running:
