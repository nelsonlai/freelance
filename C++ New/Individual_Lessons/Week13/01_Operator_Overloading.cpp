/*
 * Lesson 13.1: Operator Overloading
 * 
 * This file demonstrates advanced C++ concepts including
 * operator overloading rules, common operator overloads
 */
...
int main() {
    std::cout << "=== Advanced C++ Operator Overloading Demo ===" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 13_1_Operator_Overloading.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 13_1_Operator_Overloading.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc /O2 13_1_Operator_Overloading.cpp
 * 
 * Running:
