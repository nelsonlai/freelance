 ...
 * 
 * This file demonstrates type sizes, ranges, signed/unsigned, type conversions
 */
...
int main() {
    std::cout << "=== C++ Fundamental Type Characteristics Demo ===" << std::endl;
    std::cout << "This program demonstrates type sizes, ranges, signed/unsigned, type conversions.\n" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -o 05_2 05_2_Fundamental_Type_Characteristics.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -o 05_2 05_2_Fundamental_Type_Characteristics.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc 05_2_Fundamental_Type_Characteristics.cpp
 * 
 * Running:
 * ./05_2 (Linux/macOS)
 * 05_2.exe (Windows)
