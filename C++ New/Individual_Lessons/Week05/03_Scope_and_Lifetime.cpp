 ...
 * 
 * This file demonstrates variable scope, object lifetime, storage duration
 */
...
int main() {
    std::cout << "=== C++ Scope and Lifetime Demo ===" << std::endl;
    std::cout << "This program demonstrates variable scope, object lifetime, storage duration.\n" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -o 05_3 05_3_Scope_and_Lifetime.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -o 05_3 05_3_Scope_and_Lifetime.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc 05_3_Scope_and_Lifetime.cpp
 * 
 * Running:
 * ./05_3 (Linux/macOS)
 * 05_3.exe (Windows)
