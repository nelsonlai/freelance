...
int main() {
    std::cout << "=== Smart Pointers Demonstration ===" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -O2 -o smart_pointers 01_Smart_Pointers.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -O2 -o smart_pointers 01_Smart_Pointers.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc /O2 01_Smart_Pointers.cpp
 * 
 * Running:
