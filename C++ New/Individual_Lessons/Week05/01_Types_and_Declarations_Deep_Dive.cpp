 ...
 * 
 * This file demonstrates fundamental types, variable declarations, initialization, auto keyword
 */
...
int main() {
    std::cout << "=== C++ Types and Declarations Deep Dive Demo ===" << std::endl;
    std::cout << "This program demonstrates fundamental types, variable declarations, initialization, auto keyword.\n" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -o 05_1 05_1_Types_and_Declarations_Deep_Dive.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -o 05_1 05_1_Types_and_Declarations_Deep_Dive.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc 05_1_Types_and_Declarations_Deep_Dive.cpp
 * 
 * Running:
 * ./05_1 (Linux/macOS)
 * 05_1.exe (Windows)
