/*
 * Lesson 19.3: File System Operations
 * 
 * This file demonstrates advanced C++ concepts including
 * file operations, directory traversal, path handling
 */
...
int main() {
    std::cout << "=== Advanced C++ File System Operations Demo ===" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 19_3_File_System_Operations.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 19_3_File_System_Operations.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc /O2 19_3_File_System_Operations.cpp
 * 
 * Running:
