/*
 * Lesson 19.2: Serialization
 * 
 * This file demonstrates advanced C++ concepts including
 * object serialization, binary/text formats
 */
...
int main() {
    std::cout << "=== Advanced C++ Serialization Demo ===" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 19_2_Serialization.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 19_2_Serialization.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc /O2 19_2_Serialization.cpp
 * 
 * Running:
