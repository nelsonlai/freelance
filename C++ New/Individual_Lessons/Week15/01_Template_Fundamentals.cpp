/*
 * Lesson 15.1: Template Fundamentals
 * 
 * This file demonstrates advanced C++ concepts including
 * function templates, class templates, template parameters
 */
...
int main() {
    std::cout << "=== Advanced C++ Template Fundamentals Demo ===" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 15_1_Template_Fundamentals.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 15_1_Template_Fundamentals.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc /O2 15_1_Template_Fundamentals.cpp
 * 
 * Running:
