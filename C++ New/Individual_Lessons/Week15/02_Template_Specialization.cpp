/*
 * Lesson 15.2: Template Specialization
 * 
...
int main() {
    std::cout << "=== Advanced C++ Template Specialization Demo ===" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 15_2_Template_Specialization.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 15_2_Template_Specialization.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc /O2 15_2_Template_Specialization.cpp
 * 
 * Running:
