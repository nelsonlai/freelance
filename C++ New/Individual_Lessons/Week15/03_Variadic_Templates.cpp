/*
 * Lesson 15.3: Variadic Templates
 * 
 * This file demonstrates advanced C++ concepts including
 * template parameter packs, fold expressions
 */
...
int main() {
    std::cout << "=== Advanced C++ Variadic Templates Demo ===" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 15_3_Variadic_Templates.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 15_3_Variadic_Templates.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc /O2 15_3_Variadic_Templates.cpp
 * 
 * Running:
