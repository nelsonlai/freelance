 ...
 * 
 * This file demonstrates function overloading rules, parameter matching
 */
...
int main() {
    std::cout << "=== C++ Function Overloading Demo ===" << std::endl;
    std::cout << "This program demonstrates function overloading rules, parameter matching.\n" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -o 10_1 10_1_Function_Overloading.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -o 10_1 10_1_Function_Overloading.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc 10_1_Function_Overloading.cpp
 * 
 * Running:
 * ./10_1 (Linux/macOS)
 * 10_1.exe (Windows)
