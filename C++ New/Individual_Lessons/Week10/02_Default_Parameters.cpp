 ...
 * 
 * This file demonstrates default arguments, parameter defaults
 */
...
int main() {
    std::cout << "=== C++ Default Parameters Demo ===" << std::endl;
    std::cout << "This program demonstrates default arguments, parameter defaults.\n" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -o 10_2 10_2_Default_Parameters.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -o 10_2 10_2_Default_Parameters.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc 10_2_Default_Parameters.cpp
 * 
 * Running:
 * ./10_2 (Linux/macOS)
 * 10_2.exe (Windows)
