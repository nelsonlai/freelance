/*
 * Lesson 16.1: Template Metaprogramming
 * 
 * This file demonstrates advanced C++ concepts including
 * compile-time computation, sfinae, type traits
 */
...
int main() {
    std::cout << "=== Advanced C++ Template Metaprogramming Demo ===" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 16_1_Template_Metaprogramming.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 16_1_Template_Metaprogramming.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc /O2 16_1_Template_Metaprogramming.cpp
 * 
 * Running:
