/*
 * Lesson 18.2: Smart Pointers Advanced
 * 
 * This file demonstrates advanced C++ concepts including
 * custom deleters, weak pointers, circular references
 */
...
int main() {
    std::cout << "=== Advanced C++ Smart Pointers Advanced Demo ===" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 18_2_Smart_Pointers_Advanced.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 18_2_Smart_Pointers_Advanced.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc /O2 18_2_Smart_Pointers_Advanced.cpp
 * 
 * Running:
