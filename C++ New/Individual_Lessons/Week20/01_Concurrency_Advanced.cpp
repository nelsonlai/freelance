...
int main() {
    std::cout << "=== Advanced C++ Concurrency Advanced Demo ===" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 20_1_Concurrency_Advanced.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 20_1_Concurrency_Advanced.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc /O2 20_1_Concurrency_Advanced.cpp
 * 
 * Running:
