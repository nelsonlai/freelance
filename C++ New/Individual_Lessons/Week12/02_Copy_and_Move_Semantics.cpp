/*
 * Lesson 12.2: Copy and Move Semantics
 * 
 * This file demonstrates advanced C++ concepts including
 * rule of five, move constructors, perfect forwarding
 */
...
int main() {
    std::cout << "=== Advanced C++ Copy and Move Semantics Demo ===" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 12_2_Copy_and_Move_Semantics.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 12_2_Copy_and_Move_Semantics.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc /O2 12_2_Copy_and_Move_Semantics.cpp
 * 
 * Running:
