/*
 * Lesson 12.1: Object Lifecycle Management
 * 
 * This file demonstrates advanced C++ concepts including
 * advanced constructors, copy semantics, move semantics
 */
...
int main() {
    std::cout << "=== Advanced C++ Object Lifecycle Management Demo ===" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 12_1_Object_Lifecycle_Management.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 12_1_Object_Lifecycle_Management.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc /O2 12_1_Object_Lifecycle_Management.cpp
 * 
 * Running:
