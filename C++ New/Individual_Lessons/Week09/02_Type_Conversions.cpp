 ...
 * 
 * This file demonstrates implicit conversions, explicit casting, user-defined conversions
 */
...
int main() {
    std::cout << "=== C++ Type Conversions Demo ===" << std::endl;
    std::cout << "This program demonstrates implicit conversions, explicit casting, user-defined conversions.\n" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -o 09_2 09_2_Type_Conversions.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -o 09_2 09_2_Type_Conversions.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc 09_2_Type_Conversions.cpp
 * 
 * Running:
 * ./09_2 (Linux/macOS)
 * 09_2.exe (Windows)
