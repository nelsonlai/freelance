/*
 * Lesson 09.3: Constexpr Expressions
 * 
 * This file demonstrates compile-time evaluation, constexpr functions
 */
...
int main() {
    std::cout << "=== C++ Constexpr Expressions Demo ===" << std::endl;
    std::cout << "This program demonstrates compile-time evaluation, constexpr functions.\n" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -o 09_3 09_3_Constexpr_Expressions.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -o 09_3 09_3_Constexpr_Expressions.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc 09_3_Constexpr_Expressions.cpp
 * 
 * Running:
 * ./09_3 (Linux/macOS)
 * 09_3.exe (Windows)
