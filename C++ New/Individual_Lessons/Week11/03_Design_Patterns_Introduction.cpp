/*
 * Lesson 11.3: Design Patterns Introduction
 * 
 * This file demonstrates advanced C++ concepts including
 * singleton, factory, observer patterns in c++
 */
...
int main() {
    std::cout << "=== Advanced C++ Design Patterns Introduction Demo ===" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 11_3_Design_Patterns_Introduction.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 11_3_Design_Patterns_Introduction.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc /O2 11_3_Design_Patterns_Introduction.cpp
 * 
 * Running:
