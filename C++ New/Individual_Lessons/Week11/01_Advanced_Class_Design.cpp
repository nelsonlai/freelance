/*
 * Lesson 11.1: Advanced Class Design
 * 
 * This file demonstrates advanced C++ concepts including
 * advanced class design patterns, friend functions, static members, nested classes
 */
...
int main() {
    std::cout << "=== Advanced C++ Advanced Class Design Demo ===" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 11_1_Advanced_Class_Design.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 11_1_Advanced_Class_Design.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc /O2 11_1_Advanced_Class_Design.cpp
 * 
 * Running:
