/*
 * Lesson 11.2: Class Relationships
 * 
...
int main() {
    std::cout << "=== Advanced C++ Class Relationships Demo ===" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 11_2_Class_Relationships.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 11_2_Class_Relationships.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc /O2 11_2_Class_Relationships.cpp
 * 
 * Running:
