/*
 * Lesson 14.1: Inheritance Fundamentals
 * 
 * This file demonstrates advanced C++ concepts including
 * base and derived classes, access specifiers in inheritance
 */
...
int main() {
    std::cout << "=== Advanced C++ Inheritance Fundamentals Demo ===" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 14_1_Inheritance_Fundamentals.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 14_1_Inheritance_Fundamentals.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc /O2 14_1_Inheritance_Fundamentals.cpp
 * 
 * Running:
