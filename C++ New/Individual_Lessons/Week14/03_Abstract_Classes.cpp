/*
 * Lesson 14.3: Abstract Classes
 * 
 * This file demonstrates advanced C++ concepts including
 * pure virtual functions, abstract base classes, interfaces
 */
...
int main() {
    std::cout << "=== Advanced C++ Abstract Classes Demo ===" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 14_3_Abstract_Classes.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 14_3_Abstract_Classes.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc /O2 14_3_Abstract_Classes.cpp
 * 
 * Running:
