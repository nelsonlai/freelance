/*
 * Lesson 14.2: Virtual Functions and Polymorphism
 * 
 * This file demonstrates advanced C++ concepts including
 * virtual functions, polymorphism, virtual destructors
 */
...
int main() {
    std::cout << "=== Advanced C++ Virtual Functions and Polymorphism Demo ===" << std::endl;
 ...
 * 
 * Using GCC:
 * g++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 14_2_Virtual_Functions_and_Polymorphism.cpp
 * 
 * Using Clang:
 * clang++ -std=c++17 -Wall -Wextra -O2 -o advanced_demo 14_2_Virtual_Functions_and_Polymorphism.cpp
 * 
 * Using MSVC (Visual Studio):
 * cl /std:c++17 /EHsc /O2 14_2_Virtual_Functions_and_Polymorphism.cpp
 * 
 * Running:
