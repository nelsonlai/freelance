...
Approach: Divide and conquer - recursively divide rectangle into 4 quadrants
Time Complexity: O(log(max_coord)) in best case
Space Complexity: O(log(max_coord)) for recursion
"""
...
class Solution:
    def countShips(self, sea: 'Sea', topRight: 'Point', bottomLeft: 'Point') -> int:
        ...
        return (self.countShips(sea, Point(mid_x, topRight.y), Point(bottomLeft.x, mid_y + 1)) +
